/**
 *  Processo de renderização do documento nota.htnl
 */
...
// Capturar os dadso do formulário (Passo 1: - fluxo)
...
frmNote.addEventListener('submit', (event) => {
    ...
    // IMPORTANTE! (teste de relacionamento dos dados do form - Passo 1)
